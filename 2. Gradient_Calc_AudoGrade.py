...
for epoch in range(6):
    ...
    print('Before printing model_out',model_out)
    model_out.backward()
    print('printing weights',weights.grad)
    print('After printing model_out',model_out)
    weights.grad.zero_() # setting gradienst to zero so that every time it calculates from the start
